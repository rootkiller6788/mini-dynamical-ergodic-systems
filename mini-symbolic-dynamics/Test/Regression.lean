...
/- Regression and invariant checks for mini-symbolic-dynamics -/

#eval "=== mini-symbolic-dynamics Regression Checks ==="
...
#eval "[mini-symbolic-dynamics] Regression: all invariants preserved"
