...
/- Regression and invariant checks for mini-ergodic-theory -/

#eval "=== mini-ergodic-theory Regression Checks ==="
...
#eval "[mini-ergodic-theory] Regression: all invariants preserved"
